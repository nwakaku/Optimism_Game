...
import { polygon } from '../../components/utils/contractAddress'

function Polygon() {
    const etherscanNpngToken = `https://goerli.etherscan.io/address/${polygon.npngToken}`
    const etherscanNpngContract = `https://goerli.etherscan.io/address/${polygon.npngContract}`
    return (
        <div className="wf-section">
            <div className="div-block-33">
                <div className="div-block-34">
                    <h1>Meta-Op Game on Polygon </h1><img src="../../images/polygon-matic-logo.png" loading="lazy" width="62" alt="" className="image-13" />
                </div>
                <p className="paragraph-user-guide">To use Meta-Op Game on Polygon, you need the USDC token on the Polygon network and MATIC to cover the transaction fees. Are you still missing any of that? Have a look at <Link to="/userguide/gettingstarted" className="link-17">Getting Started</Link>!<br />If you want all the details on <Link to="/userguide/network/polygon/getting" className="link-42">how to get USDC & MATIC on Polygon follow our guidelines</Link>
                </p>
                <h2>Adding Polygon to your wallet</h2>
                <p className="paragraph-user-guide">In case you are using Metamask: The easiest way to add Polygon to your wallet is by using <a href="https://chainlist.org/chain/137" target="_blank" rel="noreferrer" className="link-25">Chainlist</a>. Simply connect your wallet and tap on “Add to Metamask”.</p>
                ...
                <p className="paragraph-user-guide">Using Meta-Op Game is simple! First, make sure you are on the Polygon network. Enter the amount of USDC you want to deposit and click on <strong>Review deposit</strong>.</p>
                ...
                <div className="w-row">
                    ...
                    <div className="column-2 w-col w-col-9">
                        ...
                        <div className="text-block-40"><a href={etherscanNpngToken} target="_blank" rel="noreferrer">{polygon.npngToken}</a></div>
                        <div className="text-block-40"><a href={etherscanNpngContract} target="_blank" rel="noreferrer">{polygon.npngContract}</a></div>
                    </div>
                </div>
